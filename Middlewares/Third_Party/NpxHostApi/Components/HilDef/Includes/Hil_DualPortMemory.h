...
***************************************************************************************
  ...
  $Id: Hil_DualPortMemory.h 3816 2018-02-28 16:09:11Z dirk $:
...
#ifndef __HIL_DUALPORTMEMORY_H
#define __HIL_DUALPORTMEMORY_H
...
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SYSTEM_CHANNEL_INFO_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_SYSTEM_CHANNEL_INFO_T;

/*****************************************************************************/
/*! Handshake channel information structure (Size always 16 Byte)            */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_HANDSHAKE_CHANNEL_INFO_Ttag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
  uint8_t   bReserved[3];                                        /*!< 0x01 reserved */
  uint32_t  ulSizeOfChannel;                                     /*!< 0x04 Size of channel in bytes */
  uint8_t   abReserved[8];                                       /*!< 0x08:0x0F Reserved area */
} __HIL_PACKED_POST HIL_DPM_HANDSHAKE_CHANNEL_INFO_T;

/*****************************************************************************/
/*! Communication channel information structure (Size always 16 Byte)        */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_COMMUNICATION_CHANNEL_INFO_Ttag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
...
} __HIL_PACKED_POST HIL_DPM_COMMUNICATION_CHANNEL_INFO_T;

/*****************************************************************************/
/*! Application channel information structure (Size always 16 Byte)          */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_APPLICATION_CHANNEL_INFO_Ttag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
  uint8_t   bChannelId;                                          /*!< 0x01 Channel / Port ID */
  uint8_t   bSizePositionOfHandshake;                            /*!< 0x02 Size and position of the handshake cells */
...
} __HIL_PACKED_POST HIL_DPM_APPLICATION_CHANNEL_INFO_T;

/*****************************************************************************/
/*! System information block (Size = 48 Byte)                                */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SYSTEM_INFO_BLOCK_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_SYSTEM_INFO_BLOCK_T;
...
} __HIL_PACKED_POST HIL_DPM_CHANNEL_INFO_BLOCK_T;

/*****************************************************************************/
/*! System information block (Size = 8 Byte)                                 */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SYSTEM_CONTROL_BLOCK_Ttag
{
  uint32_t  ulSystemCommandCOS;                                  /*!< 0x00 System channel change of state command */
  uint32_t  ulReserved;                                          /*!< 0x04 Reserved */
} __HIL_PACKED_POST HIL_DPM_SYSTEM_CONTROL_BLOCK_T;

/*****************************************************************************/
/*! System status block (Size = 64 Byte)                                     */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SYSTEM_STATUS_BLOCK_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_SYSTEM_STATUS_BLOCK_T;
...
} __HIL_PACKED_POST HIL_DPM_HANDSHAKE_CELL_T;

/*****************************************************************************/
/*! Structure of the whole system channel (DPM) (Size 512 Byte)              */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SYSTEM_CHANNEL_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_SYSTEM_CHANNEL_T;
...
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_HANDSHAKE_ARRAY_Ttag
{
  HIL_DPM_HANDSHAKE_CELL_T atHsk[HIL_DPM_HANDSHAKE_PAIRS]; /*!< Handshake cell block definition */
} __HIL_PACKED_POST HIL_DPM_HANDSHAKE_ARRAY_T;
...
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_MASTER_STATUS_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_MASTER_STATUS_T;
...
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_HANDSHAKE_BLOCK_Ttag
{
  uint8_t  abReserved[8];                                       /*!< unused/reserved */
} __HIL_PACKED_POST HIL_DPM_HANDSHAKE_BLOCK_T;

/*****************************************************************************/
/*! Channel control block (Size 8 Byte)                                      */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_CONTROL_BLOCK_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_CONTROL_BLOCK_T;

/*****************************************************************************/
/*! Channel common status block (Size 64 Byte)                               */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_COMMON_STATUS_BLOCK_Ttag
{
  ...
  } __HIL_PACKED_POST uStackDepended;                             /*!< 0x28 Stack depend status block */
} __HIL_PACKED_POST HIL_DPM_COMMON_STATUS_BLOCK_T;

/*****************************************************************************/
/*! Channel extended status block (Size 432 Byte)                            */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_EXTENDED_STATUS_BLOCK_Ttag
{
  uint8_t abExtendedStatus[HIL_DPM_EXT_STATE_SIZE];                /*!< 0x00 Extended status buffer */
} __HIL_PACKED_POST HIL_DPM_EXTENDED_STATUS_BLOCK_T;
...
typedef __HIL_PACKED_PRE struct HIL_DPM_EXTENDED_STATE_STRUCT_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_EXTENDED_STATE_STRUCT_T;

typedef __HIL_PACKED_PRE struct HIL_DPM_EXTENDED_STATE_FIELD_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_EXTENDED_STATE_FIELD_T;

typedef __HIL_PACKED_PRE struct HIL_DPM_EXTENDED_STATE_FIELD_DEFINITION_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_EXTENDED_STATE_FIELD_DEFINITION_T;
/*****************************************************************************/
/*! Channel send packet mailbox block (Size 1600 Byte)                       */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_SEND_MAILBOX_BLOCK_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_SEND_MAILBOX_BLOCK_T;

/*****************************************************************************/
/*! Channel receive packet mailbox block (Size 1600 Byte)                    */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_RECV_MAILBOX_BLOCK_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_RECV_MAILBOX_BLOCK_T;

/*****************************************************************************/
/*! Structure of the DEFAULT communication channel (Size 15616 Byte)         */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_DEFAULT_COMM_CHANNEL_Ttag
{
...
} __HIL_PACKED_POST HIL_DPM_DEFAULT_COMM_CHANNEL_T;


/*****************************************************************************/
/*! Structure of the communication channel for 8K DPM hardware (e.g. COMX10) */
/*****************************************************************************/
typedef __HIL_PACKED_PRE struct HIL_DPM_8K_DPM_COMM_CHANNEL_Ttag
{
  HIL_DPM_HANDSHAKE_BLOCK_T         tReserved;                                    /*!< 0x000:0x007 Reserved for later use */
  HIL_DPM_CONTROL_BLOCK_T           tControl;                                     /*!< 0x008:0x00F Control block */
  HIL_DPM_COMMON_STATUS_BLOCK_T     tCommonStatus;                                /*!< 0x010:0x04F Common status block */
...
} __HIL_PACKED_POST HIL_DPM_8K_DPM_COMM_CHANNEL_T;
...
#define HIL_LED_STATE_MASK                                  0x0F
#define HIL_LED_STATE_OFF                                   0x00
#define HIL_LED_STATE_SOLID_ON                              0x01
#define HIL_LED_STATE_FLICKER                               0x02
#define HIL_LED_STATE_SINGLE_FLICKER                        0x03
#define HIL_LED_STATE_FLASH_CYCLIC                          0x04
#define HIL_LED_STATE_FLASH_CYCLIC_FAST                     0x05
#define HIL_LED_STATE_SINGLE_FLASH                          0x06
#define HIL_LED_STATE_DOUBLE_FLASH                          0x07
#define HIL_LED_STATE_QUADRUPLE_FLASH                       0x08
#define HIL_LED_STATE_FLASH_NON_CYCLIC                      0x09
#define HIL_LED_STATE_TRIPLE_FLASH                          0x0A

/* LED Color State */
#define HIL_LED_COLOR_STATE_MASK                            0xF0
#define HIL_LED_COLOR_NOT_USED                              0x00
#define HIL_LED_COLOR_RED                                   0x10
#define HIL_LED_COLOR_YELLOW                                0x20
#define HIL_LED_COLOR_GREEN                                 0x30
#define HIL_LED_COLOR_BLUE                                  0x40
#define HIL_LED_COLOR_RED_GREEN                             0x50
#define HIL_LED_COLOR_RED_YELLOW                            0x60
#define HIL_LED_COLOR_GREEN_YELLOW                          0x70

/* System LED definition */
#define HIL_LED_OFF                                         0x00
#define HIL_LED_YEL_CYCLIC_FAST                             0x25
#define HIL_LED_YEL_CYCLIC                                  0x24
#define HIL_LED_YEL_NONCYCLIC                               0x29
#define HIL_LED_GRN_SOLID                                   0x31
#define HIL_LED_GRN_CYCLIC                                  0x34
#define HIL_LED_GRN_NONCYCLIC                               0x39
...
#define HIL_HW_ASSEMBLY_SERIAL                              0x0010
#define HIL_HW_ASSEMBLY_ASI                                 0x0020
#define HIL_HW_ASSEMBLY_CAN                                 0x0030
#define HIL_HW_ASSEMBLY_DEVICENET                           0x0040
#define HIL_HW_ASSEMBLY_PROFIBUS                            0x0050

#define HIL_HW_ASSEMBLY_CCLINK                              0x0070
#define HIL_HW_ASSEMBLY_ETHERNET                            0x0080
#define HIL_HW_ASSEMBLY_ETHERNET_X_PHY                      0x0081
#define HIL_HW_ASSEMBLY_ETHERNET_FIBRE_OPTIC                0x0082

#define HIL_HW_ASSEMBLY_SPI                                 0x0090
#define HIL_HW_ASSEMBLY_IO_LINK                             0x00A0
#define HIL_HW_ASSEMBLY_COMPONET                            0x00B0
...
/*      HIL_HW_DEV_CLASS_COMX         This define shall not be used anymore, please use HIL_HW_DEV_CLASS_COMX_100,
 *                                    HIL_HW_DEV_CLASS_COMX_10, HIL_HW_DEV_CLASS_COMX_50 or HIL_HW_DEV_CLASS_COMX_51 instead */
...
/*      HIL_HW_DEV_CLASS_NETIC   This define shall not be used anymore, please use HIL_HW_DEV_CLASS_NETIC_50,
 *                               HIL_HW_DEV_CLASS_NETIC_10  or HIL_HW_DEV_CLASS_NETIC_52 instead */
...
#define HIL_HW_DEV_CLASS_CIFX_4000                          0x003B
...
#define HIL_HW_DEV_CLASS_OEM_DEVICE                         0xFFFE
...
/* System Reset cookie */
#define HIL_SYS_RESET_COOKIE                                0x55AA55AA
