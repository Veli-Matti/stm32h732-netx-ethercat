...
***************************************************************************************
  ...
  $Id: Hil_Taglist.h 3816 2018-02-28 16:09:11Z dirk $:
  ...
  Description:
    ...
    The firmware also can access the data of the tag list and use the data to adapt
...
#ifndef __HIL_TAGLIST_H
#define __HIL_TAGLIST_H
...
/* Tag type mask */
#define HIL_TAG_MASK                                      0x4FFFFFFF
...
#define HIL_TAG_EIP_DEVICEID                              0x3000A000 /* tag structure description is not available */
#define HIL_TAG_EIP_EDD_CONFIGURATION                     0x3000A001 /* tag structure description is not available */
#define HIL_TAG_EIP_DLR_PROTOCOL                          0x3000A002 /* tag structure description is not available */
