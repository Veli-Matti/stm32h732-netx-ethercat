...
***************************************************************************************
  ...
  $Id: Hil_FileHeaderV3.h 3816 2018-02-28 16:09:11Z dirk $:
...
typedef __HIL_PACKED_PRE struct HIL_FILE_BOOT_HEADER_V1_0_Ttag
{
...
} __HIL_PACKED_POST HIL_FILE_BOOT_HEADER_V1_0_T, *PHIL_FILE_BOOT_HEADER_V1_0_T;


/* DEFAULT header (64 bytes, used for NXM, NXO, NXD, NXL, NXB) */
typedef __HIL_PACKED_PRE struct HIL_FILE_DEFAULT_HEADER_V1_0_Ttag
{
  uint32_t   ulMagicCookie;                /**< see HIL_FILE_HEADER_xxx_COOKIE definitions        */
  uint32_t   aulReserved[15];              /**< reserved, set to zero                             */
} __HIL_PACKED_POST HIL_FILE_DEFAULT_HEADER_V1_0_T, *PHIL_FILE_DEFAULT_HEADER_V1_0_T;


/* COMMON header (64 bytes) */
typedef __HIL_PACKED_PRE struct HIL_FILE_COMMON_HEADER_V3_0_Ttag
{
...
} __HIL_PACKED_POST HIL_FILE_COMMON_HEADER_V3_0_T, *PHIL_FILE_COMMON_HEADER_V3_0_T;


/* DEVICE-specific information (64 bytes) */
typedef __HIL_PACKED_PRE struct HIL_FILE_DEVICE_INFO_V1_0_Ttag
{
  ...
  uint32_t  aulReserved[3];               /**< reserved, set to zero                             */
} __HIL_PACKED_POST HIL_FILE_DEVICE_INFO_V1_0_T, *PHIL_FILE_DEVICE_INFO_V1_0_T;


/* MODULE-specific information (32 bytes) */
typedef __HIL_PACKED_PRE struct HIL_FILE_MODULE_INFO_V1_0_Ttag
{
  uint32_t  ulStructVersion;              /**< structure version (major, minor), 0x00010000      */
...
} __HIL_PACKED_POST HIL_FILE_MODULE_INFO_V1_0_T, *PHIL_FILE_MODULE_INFO_V1_0_T;
...
typedef __HIL_PACKED_PRE struct HIL_FILE_BASIC_HEADER_V3_0_Ttag
{
...
} __HIL_PACKED_POST HIL_FILE_BASIC_HEADER_V3_0_T, *PHIL_FILE_BASIC_HEADER_V3_0_T;


/* basic file header (without Default Header as included in ELF files used to create NXOs, 160 bytes)  */
typedef __HIL_PACKED_PRE struct HIL_FILE_MODULE_HEADER_V3_0_Ttag
{
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
  HIL_FILE_DEVICE_INFO_V1_0_T     tDeviceInfo;         /**< device-specific information                  */
  HIL_FILE_MODULE_INFO_V1_0_T     tModuleInfo;         /**< module-specific info for 1 module            */
} __HIL_PACKED_POST HIL_FILE_MODULE_HEADER_V3_0_T, *PHIL_FILE_MODULE_HEADER_V3_0_T;
...
typedef __HIL_PACKED_PRE struct HIL_FILE_MIN_HEADER_V3_0_Ttag
{
  HIL_FILE_BOOT_HEADER_V1_0_T     tBootHeader;         /**< boot header with chip settings               */
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
} __HIL_PACKED_POST HIL_FILE_MIN_HEADER_V3_0_T, *PHIL_FILE_MIN_HEADER_V3_0_T;
...
typedef __HIL_PACKED_PRE struct HIL_FILE_NXF_HEADER_V3_0_Ttag
{
  HIL_FILE_BOOT_HEADER_V1_0_T     tBootHeader;         /**< boot header with chip settings               */
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
  HIL_FILE_DEVICE_INFO_V1_0_T     tDeviceInfo;         /**< device-specific information                  */
  HIL_FILE_MODULE_INFO_V1_0_T     tModuleInfo[6];      /**< module-specific info for 6 comm. channels    */
} __HIL_PACKED_POST HIL_FILE_NXF_HEADER_V3_0_T, *PHIL_FILE_NXF_HEADER_V3_0_T;


/* NXO file header (for unrelocated optional firmware modules, 224 bytes)                              */
typedef __HIL_PACKED_PRE struct HIL_FILE_NXO_HEADER_V3_0_Ttag
{
...
} __HIL_PACKED_POST HIL_FILE_NXO_HEADER_V3_0_T, *PHIL_FILE_NXO_HEADER_V3_0_T;


/* NXD file header (for database file download, 224 bytes)                                             */
typedef __HIL_PACKED_PRE struct HIL_FILE_NXD_HEADER_V3_0_Ttag
{
  HIL_FILE_DEFAULT_HEADER_V1_0_T  tDefaultHeader;      /**< default header                               */
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
  HIL_FILE_DEVICE_INFO_V1_0_T     tDeviceInfo;         /**< device-specific information                  */
  HIL_FILE_MODULE_INFO_V1_0_T     tModuleInfo;         /**< module-specific info for 1 comm. channel     */
} __HIL_PACKED_POST HIL_FILE_NXD_HEADER_V3_0_T, *PHIL_FILE_NXD_HEADER_V3_0_T;


/* NXL file header (for license file download, 192 bytes)                                              */
typedef __HIL_PACKED_PRE struct HIL_FILE_NXL_HEADER_V3_0_Ttag
{
  HIL_FILE_DEFAULT_HEADER_V1_0_T  tDefaultHeader;      /**< default header                               */
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
  HIL_FILE_DEVICE_INFO_V1_0_T     tDeviceInfo;         /**< device-specific information                  */
} __HIL_PACKED_POST HIL_FILE_NXL_HEADER_V3_0_T, *PHIL_FILE_NXL_HEADER_V3_0_T;


/* NXB file header (for binary file download, 192 bytes)                                               */
typedef __HIL_PACKED_PRE struct HIL_FILE_NXB_HEADER_V3_0_Ttag
{
  HIL_FILE_DEFAULT_HEADER_V1_0_T  tDefaultHeader;      /**< default header                               */
  HIL_FILE_COMMON_HEADER_V3_0_T   tCommonHeader;       /**< common header                                */
  HIL_FILE_DEVICE_INFO_V1_0_T     tDeviceInfo;         /**< device-specific information                  */
} __HIL_PACKED_POST HIL_FILE_NXB_HEADER_V3_0_T, *PHIL_FILE_NXB_HEADER_V3_0_T;
